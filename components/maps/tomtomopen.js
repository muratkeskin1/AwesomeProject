(function () {
    ...
    L.Routing.TomTom = L.Class.extend({
        ...
        buildRouteUrl: function (waypoints, options) {
            var locs = [],
                ...
                _options = {
                    ...
                    computeBestOrder: this.options.computeBestOrder,
                    computeTravelTimeFor:this.options.computeTravelTimeFor,
            ...
            return this.options.serviceUrl + '/' + locs.join(':') + '/json?key=' +
                this._apiKey + '&computeBestOrder=true' + '&' + Object.keys(_options).map(function (k) {
        ...
        _convertInstructions: function (summaries) {
            ...
            for (i = 0; i < summaries.length; i++) {
                result.push({
                    distance: summaries[i].summary.lengthInMeters,
    ...
    L.Routing.tomTomTest = function (apiKey, options) {
